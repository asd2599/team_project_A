    ...
    <div className="flex justify-center items-center min-h-screen bg-white dark:bg-[#0b0f1a] transition-colors duration-300 p-8 font-sans">
      ...
      <div className="flex flex-col md:flex-row gap-20 items-stretch max-w-[950px] w-full">
            ...
            <div className="aspect-square w-full bg-gray-50 dark:bg-gray-900/50 rounded-[3.5rem] border border-gray-100 dark:border-gray-800 mb-8 flex items-center justify-center shadow-sm relative overflow-hidden">
              {petData && (
                <img
                  ...
                  alt={petData.name}
                  className="w-52 h-52 object-contain hover:scale-110 transition-transform duration-500 drop-shadow-2xl"
                />
              )}
            </div>

            <div className="text-center">
              <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tighter italic">{petData?.name}</h2>
              <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-2 font-bold uppercase tracking-[0.3em]">Lv. {petData?.level}</p>
            </div>
          </div>
          ...
          <div className="pt-12">
            <div className="space-y-2.5 mb-6">
              <div className="flex justify-between items-end px-1">
                ...
                <span className="text-[10px] font-bold text-gray-900 dark:text-gray-100">{Math.floor(progress)}%</span>
              </div>
            ...
            <div className="flex justify-between items-center py-4 px-5 bg-gray-50/50 dark:bg-gray-900/30 border border-gray-100 dark:border-gray-800 rounded-[1.5rem] mb-3">
              ...
              <span className="text-[11px] font-bold text-gray-900 dark:text-white uppercase tracking-tight">{petData?.tendency}</span>
            </div>
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                >
                  <menu.icon className={`text-[16px] text-gray-400 mb-1.5 transition-colors ${menu.color}`} />
                  <span className="text-[9px] font-bold text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white transition-colors">{menu.label}</span>
                </button>
              ))}
            </div>
          </div>
        ...
        <div className="w-full flex-1 flex flex-col justify-between py-2">
          ...
          {/* Survival 섹션 */}
          <section>
            <h3 className="text-[9px] font-black text-gray-300 dark:text-gray-700 uppercase tracking-[0.3em] mb-5 border-b border-gray-50 dark:border-gray-900 pb-2 font-mono italic">Survival</h3>
            <div className="space-y-1">
              {[
                ...
                <div key={idx} className="flex items-center py-1.5 group">
                  <span className="text-[11px] text-gray-400 dark:text-gray-500 font-bold w-20 transition-colors group-hover:text-gray-900 dark:group-hover:text-white">{stat.label}</span>
                  <span className="text-[11px] font-black text-gray-900 dark:text-gray-100 font-mono tracking-tighter">{stat.value}</span>
                </div>
              ))}
            </div>
          </section>
          ...
          <section>
            <h3 className="text-[9px] font-black text-gray-300 dark:text-gray-700 uppercase tracking-[0.3em] mb-5 border-b border-gray-50 dark:border-gray-900 pb-2 font-mono italic">Mind & Intelligence</h3>
            <div className="space-y-1">
              {[
          ...
          <section>
            <h3 className="text-[9px] font-black text-gray-300 dark:text-gray-700 uppercase tracking-[0.3em] mb-5 border-b border-gray-50 dark:border-gray-900 pb-2 font-mono italic">Social & Personality</h3>
            <div className="space-y-1">
              {[
