  ...
  return (
    <div className="flex flex-col lg:flex-row h-screen bg-white dark:bg-[#0b0f1a] transition-colors duration-500 font-sans overflow-hidden">
      ...
      <main className="flex-1 flex flex-col lg:flex-row items-stretch p-3 lg:p-8 gap-4 lg:gap-8 bg-[#fcfcfc] dark:bg-[#0b0f1a] h-[calc(100vh-64px)] lg:h-full overflow-y-auto lg:overflow-hidden custom-scrollbar">
        ...
        <div className="w-full lg:w-[380px] flex flex-col justify-between shrink-0 lg:py-2 h-full">
                    ...
                    {section.stats.map((key) => {
                      ...
                      return (
                        <div key={key} className="flex items-center gap-2 lg:gap-3.5 p-2 lg:p-3.5 rounded-2xl bg-white dark:bg-gray-900 border border-gray-100/50 dark:border-gray-800 shadow-[0_4px_12px_rgba(0,0,0,0.02)] transition-all hover:scale-[1.03] hover:shadow-lg group">
                          <div className={`w-7 h-7 lg:w-8 lg:h-8 rounded-xl flex items-center justify-center shrink-0 ${isDarkMode ? 'bg-gray-800' : 'bg-gray-50'}`}>
        ...
        <div className="flex-1 flex flex-col bg-white dark:bg-gray-900/40 border border-gray-100 dark:border-gray-800 rounded-4xl lg:rounded-[3rem] shadow-sm overflow-hidden relative h-full">
          <div className="px-6 lg:px-8 py-4 lg:py-5 border-b border-gray-50 dark:border-gray-800 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm flex justify-between items-center shrink-0">
            ...
            {messages.map((msg, i) => (
              <div key={i} className={`flex ${msg.sender === "user" ? "justify-end" : "justify-start"} animate-fade-in-up`}>
                <div className={`max-w-[90%] lg:max-w-[85%] flex items-start gap-3 lg:gap-4 ${msg.sender === "user" ? "flex-row-reverse" : "flex-row"}`}>
                  <div className={`w-8 h-8 lg:w-9 lg:h-9 rounded-xl lg:rounded-2xl flex items-center justify-center shrink-0 border ${msg.sender === "user" ? "bg-gray-900 border-gray-800 shadow-md" : "bg-white dark:bg-gray-800 border-gray-100 dark:border-gray-700 shadow-sm"}`}>
          ...
          <div className="p-4 lg:p-8 bg-white/80 dark:bg-gray-900/80 backdrop-blur-xl border-t border-gray-50 dark:border-gray-800 shrink-0">
